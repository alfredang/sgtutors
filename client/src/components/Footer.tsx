...
function AppStoreBadge() {
  return (
    ...
    >
      ...
      <g fill="#fff" transform="translate(-3.7 0)">
        <path
          transform="translate(5.5 0)"
          d="M28.05 22.84c-.03-3.17 2.6-4.71 2.72-4.78-1.49-2.17-3.79-2.47-4.61-2.5-1.94-.2-3.82 1.16-4.81 1.16-1.01 0-2.53-1.14-4.17-1.11-2.11.03-4.09 1.25-5.17 3.15-2.24 3.87-.57 9.56 1.57 12.69 1.07 1.53 2.32 3.25 3.96 3.19 1.6-.07 2.2-1.02 4.13-1.02 1.91 0 2.47 1.02 4.14.98 1.72-.03 2.8-1.55 3.83-3.09 1.23-1.76 1.73-3.49 1.75-3.58-.04-.01-3.33-1.27-3.36-5.06zM24.9 13.5c.87-1.09 1.47-2.57 1.3-4.07-1.26.06-2.83.87-3.74 1.94-.81.94-1.53 2.48-1.34 3.92 1.42.11 2.87-.71 3.78-1.79z"
        />
        <text
          x="44"
          y="18"
